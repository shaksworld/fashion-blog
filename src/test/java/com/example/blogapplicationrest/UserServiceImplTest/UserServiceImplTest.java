...
class UserServiceImplTest {
    ...
    @BeforeEach
    void setUp() {
        localDateTime = LocalDateTime.of(2023, FEBRUARY,15,6,30,40,50000);
        user = new User(1 , "shaka" , "shaka@gmail.com" , "Admin" , "12345" , localDateTime , localDateTime  , postList , commentList , likeList);
    ...
    @Test
    void register() {
        UserDto userDTO = new UserDto( "shaka" , "shaka@gmail.com" , "Admin" , "12345");
        ...
        assertEquals(userDTO.getName() , actual.getUser().getName());
//        assertEquals(registerResponse , actual);

//        registerResponse.setTimeStamp(localDateTime);
//        registerResponse.getUser().setCreatedAt(localDateTime);
//        registerResponse.getUser().setUpdatedAt(localDateTime);
//        registerResponse.getUser().setId(1);
//        assertEquals(registerResponse , actual);
    }

    @Test
    void login_SuccessFullLogin() {
        LoginDto loginDto = new LoginDto("shaka@gmail.com" , "12345");
        when(userRepository.findUserByEmail("shaka@gmail.com")).thenReturn(Optional.ofNullable(user));
    ...
    void login_IncorrectPassword() {
        LoginDto loginDto = new LoginDto("shaka@gmail.com" , "123rft8745");
        when(userRepository.findUserByEmail("shaka@gmail.com")).thenReturn(Optional.ofNullable(user));
